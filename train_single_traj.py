...
dataset_path_rbc="data_interactions/RBCAgent1/model_RBCAgent1_timesteps_100000_rf_CombinedReward_seed_28_norm_wrapper.pkl"
dataset_path_ppo="data_interactions/PPO/model_PPO_timesteps_100000_rf_CombinedReward_seed_28_norm_wrapper.pkl"
dataset_path_sac="data_interactions/SAC/model_SAC_timesteps_100000_rf_CombinedReward_seed_28_norm_wrapper.pkl"

dataset_rbc = load_from_disk(dataset_path_rbc)
dataset_ppo = load_from_disk(dataset_path_ppo)
dataset_sac = load_from_disk(dataset_path_sac)

replay_buffer = ReplayBufferTrajectory(200,dataset_rbc)
replay_buffer.add_new_dataset(dataset_ppo)
replay_buffer.add_new_dataset(dataset_sac)
...
class Experiment:
    def __init__(self, variant,dataset_path,config_path = "configs/medium/city_learn_traj_v1_seq20_rf_CombinedReward_norm_wrapper.yaml"):
        ...
        self.replay_buffer = ReplayBufferTrajectory(200,dataset_rbc)
        #replay_buffer = ReplayBufferTrajectory(200,dataset_rbc)
        self.replay_buffer.add_new_dataset(dataset_ppo)
        self.replay_buffer.add_new_dataset(dataset_sac)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="./exp/single_traj")
